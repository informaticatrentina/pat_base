...
{ezcss_require(array(
    ...
    'plugins/leaflet/geocoder/Control.Geocoder.css',
    'plugins/leaflet/Control.Loading.css'
))}
{ezscript_require(array(
    ...
    'plugins/leaflet/geocoder/Control.Geocoder.js',
    'plugins/leaflet/geocoder/osmaplocation.js'
))}
