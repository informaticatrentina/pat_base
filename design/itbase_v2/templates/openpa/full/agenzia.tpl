<div class="content-view-full row">
    ...
    <div class="content-related">
        ...
        <ul class="list-unstyled">
           {if $node|has_attribute('agenzia_deliberante')}
                <li>
                    <b>{"ActAgency"|i18n('design/itbase_v2/provvedimenti')}</b>
                    <p>
                        {attribute_view_gui attribute=$node|attribute('agenzia_deliberante')}
                    </p>
                </li>
            {/if}    
            ...
            {if $node|has_attribute('riferimento')}
                <li>
                    <b>{"reference"|i18n('design/itbase_v2/provvedimenti')}</b>
                    <p>
